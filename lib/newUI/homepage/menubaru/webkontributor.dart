...
class WebKontributor extends StatefulWidget {
  const WebKontributor({Key? key}) : super(key: key);

  @override
  _WebKontributorState createState() => _WebKontributorState();
}

class _WebKontributorState extends State<WebKontributor> {
  bool isLoading = true;
  InAppWebViewController? _webViewController;
  final String url =
      'https://awaksigap.madiunkota.go.id/masuk/kontribusiberita';
